# Generated by Django 4.1.3 on 2023-01-20 04:53
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('games', multiselectfield.db.fields.MultiSelectField(choices=[('C', 'Cricket'), ('F', 'Football'), ('G', 'General')], default='G', max_length=5)),
